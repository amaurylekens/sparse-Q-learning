...
class Game:
    ...
    def play(self, actions):
        ...
        if collision:
            ...
            direction = directions[np.random.choice(list(range(len(directions))), 
    ...
    def random_position(self):
        ...
        self.states = {pred_id: state for pred_id, state in enumerate(new_states)}
